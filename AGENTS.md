...
- QR redirects append outbound UTM parameters in `src/lib/links.ts` from link metadata: source from variant/slug, medium `qr`, campaign from `campaign`, and content from slug.
